    ...
    <Section id={ id } className={ className }>
      ...
      <div className={ styles.about_me_section_wrapper }>
        <div className={ styles.text_wrapper }>
          <Text.Paragraph>
            Hello! I’m Knowledge Musa, a software engineer with well over 6 years of experience in demanding environments focused in building user centered & cutting-edge applications.
          </Text.Paragraph>
